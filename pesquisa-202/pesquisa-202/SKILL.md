...
- `voice.rules.md` (cópia em `references/`) — define o que é "valor agregado" e "tese" para a
  202. É o que orienta o viés da pesquisa.
- O dossiê alimenta o **agente de conteúdo** (próximo ciclo), que escreve o storytelling e emite
  o JSON consumido pela skill `instagram-202-render`.
